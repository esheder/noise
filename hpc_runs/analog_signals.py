...
par = AnalogParameters.from_dubi(-500e-5, 5e-5, 1e6, multiplicity, 1e-4)
...
if __name__ == '__main__':
    ...
    t = 600.
    ts, curve, sigma = feynman_y_by_signal(par, t, rand_gen=generator, signal_generator=signal_make)
    mask = (ts <= 1e-1)
